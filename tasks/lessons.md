...
- 2026-05-11: When a user corrects the apparent bug report, re-verify the actual product goal against repo reality before continuing implementation.
- 2026-05-11: When the product contract is narrowed to one supported format, remove both the legacy behavior and any “preferred” wording that implies alternatives still exist.
- 2026-05-11: When docs call a feature “planned” but the codebase already has pure contracts for it, the next honest step is runtime wiring plus smoke-test evidence, not more future-language cleanup.
